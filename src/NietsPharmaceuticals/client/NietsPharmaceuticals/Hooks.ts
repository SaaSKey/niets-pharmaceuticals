import { ISTakePillAction, IsoPlayer, InventoryItem, getPlayer, ISTimedActionQueue, KahluaTable, _instanceof_, getText } from "PipeWrench"
import { hookInto } from "PipeWrench-Utils"
import { onFillInventoryObjectContextMenu, onGameStart } from "PipeWrench-Events"
