...
const ProceduralDistributions = getGlobal<KahluaTable>(
...
type RemoveItemFromDistributionFunction = (
  _dist: KahluaTable,
  _item: string,
  _chance: number,
  _dorecursive: boolean
) => void;

// Get global function RemoveItemFromDistribution
const RemoveItemFromDistribution =
  getGlobal<RemoveItemFromDistributionFunction>("RemoveItemFromDistribution");
